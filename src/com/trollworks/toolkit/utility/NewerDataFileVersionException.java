...
public class NewerDataFileVersionException extends IOException {
    ...
    @Localize(locale = "pt-BR",
              value = "O arquivos de dados é de uma versão mais recente {0} e não pode ser carregado.")
    @Localize(locale = "ru",
              value = "Файл с данными относится к более поздней версии {0} и не может быть загружен.")
    @Localize(locale = "de",
              value = "Die Datendatei ist von einer neueren Version von {0} und kann nicht geladen werden.")
    @Localize(locale = "es",
              value = "El archivo se ha creado con una versión más reciente {0} y no puede abrirse")
